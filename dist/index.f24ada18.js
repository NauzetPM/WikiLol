...
})({"3Y5HO":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "06a1944ef24ada18";
"use strict";
...
},{}],"6F9Bw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _championJs = require("./Champion.js");
var _championJsDefault = parcelHelpers.interopDefault(_championJs);
var champions = [];
...
const startLol = async ()=>{
    ...
    const championPromises = Object.entries(array).map(async ([name, champion])=>{
        ...
        const champ = new (0, _championJsDefault.default)(Object.entries(champData.data)[0][1]);
        pushChampion(champ);
    });
...
const showLol = async ()=>{
    ...
    for(let i = 0; i < champions.length; i++)lols.innerHTML += `
...
window.showChampionInfo = (index)=>{
    ...
    <div class="carousel-slide" style="display: ${i === 0 ? "block" : "none"};">
        ...
        <h4 class="skin-name">${skin.name}</h4> <!-- Aqu\xed se muestra el nombre de la skin -->
    </div>
`).join("");
    const modalContent = `
...
},{"./Champion.js":"lO8jG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lO8jG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["3Y5HO","6F9Bw"], "6F9Bw", "parcelRequire94c2")

//# sourceMappingURL=index.f24ada18.js.map
